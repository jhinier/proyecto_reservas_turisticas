<div class="min-h-screen bg-white" wire:key="reserva-root-container">
    <div class="max-w-5xl mx-auto p-4 md:p-8">
        ...
        <div class="w-full space-y-6">
            ...
            @if($paso === 3)
                ...
                <div class="flex justify-center md:justify-end mt-8">
                    <button wire:click="finalizarAgendamiento" wire:loading.attr="disabled" class="px-10 py-4 bg-[#32744C] hover:bg-[#4C4F26] text-white font-black rounded-full transition-all shadow-xl shadow-[#32744C]/20 uppercase text-xs tracking-widest flex items-center gap-2">
        ...
        {{-- ESPACIADOR FANTASMA: Empuja la página hacia arriba para que el carrito inferior no tape el contenido --}}
        @if($paso !== 3)
    ...
    {{-- El NUEVO carrito inferior (Sticky Bottom Bar) --}}
    @if($paso !== 3)
